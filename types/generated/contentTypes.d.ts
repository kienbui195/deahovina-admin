...
export interface ApiCompanyInfoCompanyInfo extends Schema.SingleType {
  ...
  attributes: {
    main_specialization: Attribute.Component<
      'company-info.main-specialization',
      true
    > &
      Attribute.SetPluginOptions<{
        i18n: {
    ...
    basic_info: Attribute.Component<'company-info.basic-information', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    about_info: Attribute.Component<'company-info.about-info'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiCustomerSiteCustomerSite extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String & Attribute.Required;
    slug: Attribute.UID<'api::customer-site.customer-site', 'name'> &
      Attribute.Required;
    projects: Attribute.Relation<
      'api::customer-site.customer-site',
      'oneToMany',
      'api::project.project'
    >;
...
export interface ApiGlobalGlobal extends Schema.SingleType {
  ...
  attributes: {
    top_banner: Attribute.Component<'common.top-banner', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    attach_file_vi: Attribute.Media<'files'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }>;
    attach_file_en: Attribute.Media<'files'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
      }>;
    attach_file_kr: Attribute.Media<'files'> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiProductBrandProductBrand extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::product-brand.product-brand', 'name'> &
      Attribute.Required &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    customer_site: Attribute.Relation<
      'api::project.project',
      'manyToOne',
      'api::customer-site.customer-site'
    > &
...
export interface ApiUserContactUserContact extends Schema.CollectionType {
  ...
  attributes: {
    ...
    user_contact_content: Attribute.Text & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::customer-site.customer-site': ApiCustomerSiteCustomerSite;
